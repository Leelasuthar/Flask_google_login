...
cred = credentials.Certificate("") # write your firebase json file path
firebase_admin.initialize_app(cred)

# OAuth configuration
oauth = OAuth(app)
GOOGLE_CLIENT_ID = ' ' # write your google_client_id from google developer console 
GOOGLE_CLIENT_SECRET = ' ' # write your google_client_secret from google developer console 
